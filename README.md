...
1. [Decision Trees Classification](1_Decision_Trees_Classification.ipynb)
2. [Decision Trees Regression](2_Decision_Trees_Regression.ipynb)
3. [Decision Trees Recap](3_Decision_Trees_Recap.ipynb)

The first notebook will show you how to implement
Decision Trees on a classification problem with scikit-learn. 
In the second notebook, you will use the algorithm on a regression problem.
...
- have seen the typical structure of a python script (using functions, calling them in main function at the end)
